...
public class s_T0013 {
	...
	public void s_T0013_send(DTO DTO, HashMap<String, ObjectOutputStream> userOOSMap, String[][][] gameinfo, String[][][] place) {
		...
		int p1 = Integer.parseInt(gameinfo[RN][2][0]);								// 1p 머니 임시저장 
		int p2 = Integer.parseInt(gameinfo[RN][2][1]); 								// 2p 머니 임시저장
		int p3 = Integer.parseInt(gameinfo[RN][2][2]); 								// 3p 머니 임시저장
		int p4 = Integer.parseInt(gameinfo[RN][2][3]); 								// 4p 머니 임시저장
