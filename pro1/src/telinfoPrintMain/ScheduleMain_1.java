...
public class ScheduleMain_1 extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					ScheduleMain_1 frame = new ScheduleMain_1();
	...
	public ScheduleMain_1() {
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				try {
				TelInfoDAO tid=new TelInfoDAO();
				for(TelInfoVO tiv : tid.schedule(year, month, day)) {
