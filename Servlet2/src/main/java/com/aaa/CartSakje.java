...
public class CartSakje extends HttpServlet {
	...
	if(session!=null) {
		...
		out.print("<a href='JangBasket6.html'>상품목록</a>");
		out.print("</html></body>");
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		 ...
		 * out.print("cart empty~~~"); //세션객체 얻기 HttpSession
		 * session=request.getSession(false); if(session!=null) { session.invalidate();
		 * }else { out.print("세션없음"+"<br>"); }
		 * 
		 * out.print("<a href='car.html'>car골라</a><br>"); out.print("</body></html>");
		 */
	}
